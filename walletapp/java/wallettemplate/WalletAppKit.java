    ...
    protected void startUp() throws Exception {
        ...
        try {
            ...
            if (peerAddresses != null) {
                ...
                peerAddresses = null;
            } else if (!useTor) {//기존의 비트코인은 DnsDiscovery를 사용, DNSseed의 whitecolor peer를 연결하지만 우리 앱은 addrseed(ip)를 사용한다.
            	if(params.getId().equals(NetworkParameters.ID_REGTEST))
            		vPeerGroup.addPeerDiscovery(discovery != null ? discovery : new SeedPeers(params));
            	else vPeerGroup.addPeerDiscovery(discovery != null? discovery: new DnsDiscovery(params));
            }
