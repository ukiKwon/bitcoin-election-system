 ...
 */
public class NotificationBarPane extends BorderPane {//top, bottom, right, left 셀에 컨트롤을 배치하는 컨테이너, 컨트롤 뿐 아니라 다른 컨테이너 배치도 가능 --> 다양한 레이아웃 생성
    ...
    private HBox bar;//HBox : 수평 배치 레이아웃
    private Label label;
    private double barHeight;
    private ProgressBar progressBar;//어떤 것의 진척 정도를 나타내기 위해 사용
