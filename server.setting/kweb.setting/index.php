        ...
        if($result) {
        	$u_reg=isset($_POST['u_reg']) ? $_POST['u_reg'] : '';
                ...
                if(is_null($row['regisid'])) {
                        ...
                        if(strcmp($row['regisid'], $u_reg)) { #Not registerd
                                echo "0"; 
                        } else { 		#registered
                                # Is Manager check
						...
						#echo("<script>location.replace('./manager.php');</script>");
                                                        ...
                                                        echo "4402"."</br>";} 
                                        } else {  # Not a manager, but voter
                                                echo  "1401"."</br>";
						echo("<script>location.replace('./voter.php');</script>");}

                                } else { 
                                echo "4401"."</br>";} #Managers doesn't exist in kdb.
                        }
